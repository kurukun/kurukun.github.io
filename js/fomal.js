...
document.addEventListener('pjax:complete', function () {
  ...
  $.ajax({
    ...
    data: {
      key: 'I72BZ-QQ26I-VD5GD-UA2CE-P2XD5-DPBBI',  // 这里要写你的KEY!!!
      output: 'jsonp',
    },
    dataType: 'jsonp',
  ...
  function showWelcome() {
    ...
    let dist = getDistance(113.36128, 23.16403, ipLoacation.result.location.lng, ipLoacation.result.location.lat); //这里换成自己的经纬度
  ...
  function share_() {
    ...
    try {
      ...
      var subTitle = title.endsWith("| KuruのSekai") ? title.substring(0, title.length - 14) : title;
      navigator.clipboard.writeText('KuruのSekai的站内分享\n标题：' + subTitle + '\n链接：' + url + '\n欢迎来访！🍭🍭🍭');
      new Vue({
        data: function () {
          this.$notify({
            title: "成功复制分享信息🎉",
  ...
  */
  ...
  function createtime() {
    ...
    var start = new Date("07/25/2023 00:00:00"); // 旅行者1号开始计算的时间
    var dis = Math.trunc(23400000000 + ((now - start) / 1000) * 17); // 距离=秒数*速度 记住转换毫秒
    var unit = (dis / 149600000).toFixed(6);  // 天文单位
    // 网站诞生时间
    var grt = new Date("07/25/2023 00:00:00");
  ...
  if (localStorage.getItem("blogbg") != undefined) {
    ...
    document.getElementById("defineBg").innerText = `:root{
      --default-bg: url(https://picbed.otakuru.top/light.jpg);
      --darkmode-bg:url(https://picbed.otakuru.top/dark.jpg);
      --mobileday-bg: url(https://picbed.otakuru.top/mlight.jpg);
      --mobilenight-bg: url(https://picbed.otakuru.top/mdark.jpg);
    }`;
  }
  // 切换背景主函数
  function changeBg(s) {
  ...
  <details class="folding-tag" cyan><summary> 查看二次元背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/moe/m1.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/moe/m1.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/moe/m2.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/moe/m2.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/moe/m3.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/moe/m3.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/moe/m4.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/moe/m4.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/moe/m5.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/moe/m5.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/moe/m6.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/moe/m6.jpg)')"></a></div>
              </div>
            </details>
  ...
  <details class="folding-tag" cyan><summary> 查看风景背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/scene/s1.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/scene/s1.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/scene/s2.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/scene/s2.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/scene/s3.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/scene/s3.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/scene/s4.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/scene/s4.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/scene/s5.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/scene/s5.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/scene/s6.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/scene/s6.jpg)')"></a></div>
              </div>
            </details>
  ...
  <details class="folding-tag" cyan><summary> 查看萌宠背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/pet/p1.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/pet/p1.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/pet/p2.jpg)" class="imgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/pet/p2.jpg)')"></a></div>
              </div>
            </details>
  ...
  <details class="folding-tag" cyan><summary> 查看适配手机的背景 </summary>
              <div class='content'>
              <div class="bgbox"><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/mobile/p1.jpg)" class="pimgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/mobile/p1.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/mobile/p2.jpg)" class="pimgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/mobile/p2.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/mobile/p3.jpg)" class="pimgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/mobile/p3.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/mobile/p4.jpg)" class="pimgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/mobile/p4.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/mobile/p5.jpg)" class="pimgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/mobile/p5.jpg)')"></a><a href="javascript:;" rel="noopener external nofollow" style="background-image:url(https://picbed.otakuru.top/img/mobile/p6.jpg)" class="pimgbox" onclick="changeBg('url(https://picbed.otakuru.top/img/mobile/p6.jpg)')"></a></div>
              </div>
            </details>
