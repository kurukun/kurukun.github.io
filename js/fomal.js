...
document.addEventListener('pjax:complete', function () {
  ...
  function createtime2() {
    ...
    setTimeout(
      console.warn.bind(
        console,
        "%c ⚡ Powered by Kuru %c 你正在访问Kuru的blog",
  ...
  */
  ...
  //  小歪高清壁纸
  let waiBizhi = "url(https://api.paugram.com/wallpaper/)";
  // 博天随机
  ...
  <p id="swfs">
  <a class="swf" id="swf_ZhuZiAWan" href="javascript:;" rel="noopener external nofollow" style="font-family:'ZhuZiAWan'!important;color:black" onclick="setFont('ZhuZiAWan')">网站默认</a>
